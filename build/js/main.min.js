...
/* harmony import */ var _modules_dino_tape__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/dino-tape */ "./js/modules/dino-tape.js");
/* harmony import */ var _modules_tablet_main_intro__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tablet-main-intro */ "./js/modules/tablet-main-intro.js");
...
try {
  ...
  Object(_modules_dino_tape__WEBPACK_IMPORTED_MODULE_4__["animateDinoTape"])();
}

Object(_modules_tablet_main_intro__WEBPACK_IMPORTED_MODULE_5__["initIntroSlideClick"])();

/***/ }),

/***/ "./js/modules/dino-tape.js":
/*!*********************************!*\
  !*** ./js/modules/dino-tape.js ***!
  \*********************************/
/*! exports provided: animateDinoTape */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animateDinoTape", function() { return animateDinoTape; });
var dinozavr = document.querySelector('.dinozavr');
var tape = dinozavr.querySelectorAll('.dinozavr__tape');
var breakpointTablet = window.matchMedia('(max-width: 1023px)');
var ANIMATION_DELAY = 1300;

var animateDinoTape = function animateDinoTape() {
  if (dinozavr) {
    breakpointChecker();
    tape.forEach(function (it) {
      showTape(it);
    });
  }
};

var showTape = function showTape(element) {
...
/* harmony import */ var _dino_tape__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dino-tape */ "./js/modules/dino-tape.js");

var header = document.querySelector('.header');
var introLeft = document.querySelector('.main-intro__left');
var introRight = document.querySelector('.main-intro__right');
var loader = document.querySelector('.loader');
var loaderButton = document.querySelector('.loader__button');
var breakpointTablet = window.matchMedia('(max-width: 1023px)');
var contentToAnimate = [header, introLeft, introRight];
var ANIMATION_DELAY = 600;
var ANIMATION_EDN = 2600;

var hideContent = function hideContent() {
  document.documentElement.style.overflow = 'hidden';
  contentToAnimate.forEach(function (it) {
...
var initLoader = function initLoader() {
  if (loader) {
    ...
    Object(_dino_tape__WEBPACK_IMPORTED_MODULE_0__["animateDinoTape"])();
  }
};
...
var onDocumentLoaderClick = function onDocumentLoaderClick(evt) {
  evt.preventDefault();
  removeLoader();
  Object(_dino_tape__WEBPACK_IMPORTED_MODULE_0__["animateDinoTape"])();
};

var onDocumentLoaderEnterPress = function onDocumentLoaderEnterPress(evt) {
  if (evt.key === 'Enter') {
    evt.preventDefault();
    removeLoader();
    Object(_dino_tape__WEBPACK_IMPORTED_MODULE_0__["animateDinoTape"])();
...
var breakpointCheckerAndListener = function breakpointCheckerAndListener() {
  if (breakpointTablet.matches) {
...
/***/ "./js/modules/tablet-main-intro.js":
/*!*****************************************!*\
  !*** ./js/modules/tablet-main-intro.js ***!
  \*****************************************/
/*! exports provided: initIntroSlideClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIntroSlideClick", function() { return initIntroSlideClick; });
var mainIntro = document.querySelector('.main-intro');
var mainIntroRight = mainIntro.querySelector('.main-intro__right');
var mainIntroLeft = mainIntro.querySelector('.main-intro__left');
var breakpointTablet = window.matchMedia('(max-width: 1023px)');

var initIntroSlideClick = function initIntroSlideClick() {
  if (mainIntro && breakpointTablet.matches) {
    mainIntroLeft.addEventListener('click', function () {
      mainIntroRight.classList.add('fade-in-left');
      mainIntroRight.classList.remove('fade-out-left');
    });
    mainIntroRight.addEventListener('click', function () {
